...
TEST_CASE("Scheduler::isOverdue") {
    CHECK_FALSE(
        Scheduler::isOverdue(makeCard(kStart, Stage::Day0), kToday));  // due today, not overdue
...
TEST_CASE("Scheduler::markCompleted advances each stage") {
    ...
    const Step steps[] = {
        {Stage::Day0, Stage::Day1, {2026, 4, 30}},   {Stage::Day1, Stage::Day2, {2026, 5, 1}},
        {Stage::Day2, Stage::Day5, {2026, 5, 4}},    {Stage::Day5, Stage::Day15, {2026, 5, 14}},
